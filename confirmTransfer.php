...
<body>
        ...
        <div class="modal fade" id="confirmModal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    ...
                    <form action="confirmTransfer/toConfirmTransfer.php" method="POST">
                        ...
                        <div class="container">
                            ...
                            <div class="row-sm-6">
                                <div class="container">
                                    ...
                                    <div class="row mb-3">
                                        <p class="text-center fs-5">The equipment has been successfully transferred, do you want to confirm this?</p>
                                    </div>
                                    ...
                                    <fieldset>
                                        ...
                                        <div class="row">
                                            <div class="form-group mb-3">
                                                <input type="text" name="id" id="id" placeholder="Equipment Id" class="form-control form-cntrol-sm" readonly>
                                            </div>
                                        </div>

                                        <div class="row">
                                            <div class="form-group mb-3">
                                                <input type="text" name="name" id="name" placeholder="Equipment Name" class="form-control form-cntrol-sm" readonly>
                                            </div>
                                        </div>
                                        
                                        <div class="row">
                                            <div class="form-group mb-3">
                                                <input type="text" name="brand" id="brand" placeholder="Equipment Brand" class="form-control form-cntrol-sm" readonly>
                                            </div>
                                        </div>

                                        <div class="row">
                                            <div class="form-group mb-3">
                                                <textarea class="form-control" name="description" id="description" rows="5" placeholder="Description. . ." readonly></textarea>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="form-group mb-3">
                                                ...
                                                <input type="date" name="distribution_date" id="distribution_date" placeholder="Distribution Date" class="form-control form-cntrol-sm" readonly>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="form-group mb-3">
                                                <input type="text" name="distribution_quantity" id="distribution_quantity" placeholder="Distribution Quantity" class="form-control form-cntrol-sm" readonly>
                                            </div>
                                        </div>

                                        <div class="row">
                                            <div class="form-group mb-3">
                                                <label for="in_charge" class="form-label">New In Charge</label>
                                                <input type="text" name="in_charge" id="in_charge" placeholder="New In Charge" class="form-control form-cntrol-sm" readonly>
                                            </div>
                                        </div>

                                        <div class="row">
                                            <div class="form-group mb-3">
                                                <label for="transferred_date" class="form-label">Transferred Date</label>
                                                <input type="date" name="transferred_date" id="transferred_date" placeholder="Transferred Date" class="form-control form-cntrol-sm" readonly>
                                            </div>
                                        </div>

                                        <div class="row">
                                            <div class="form-group mb-3">
                                                <label for="p_in_charge" class="form-label">Previous In Charge</label>
                                                <input type="text" name="p_in_charge" id="p_in_charge" placeholder="Previous In Charge" class="form-control form-cntrol-sm" readonly>
                                            </div>
                                        </div>
                                    </fieldset>
                                </div>
    ...
    <script src="confirmTransfer/loadPendingTransferData.js"></script>
