...
<body>
        ...
        <div class="modal fade" id="confirmModal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    ...
                    <form action="confirmCondemn/toConfirmCondemn.php" method="POST">
                        ...
                        <div class="container">
                            ...
                            <div class="row-sm-6">
                                <div class="container">
                                    ...
                                    <div class="row mb-3">
                                        <p class="text-center fs-5">The equipment has been successfully condemned, do you want to confirm this?</p>
                                    </div>
                                    ...
                                    <fieldset>
                                        ...
                                        <div class="row">
                                            <div class="form-group mb-3">
                                                <input type="text" name="condemn_no" id="condemn_no" placeholder="Condemn No" class="form-control form-cntrol-sm" readonly>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="form-group mb-3">
                                                <input type="text" name="date_distributed" id="date_distributed" placeholder="Date Distributed" class="form-control form-cntrol-sm" readonly>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="form-group mb-3">
                                                <input type="text" name="in_charge" id="in_charge" placeholder="Person In Charge" class="form-control form-cntrol-sm" readonly>
                                            </div>
                                        </div>

                                        <div class="row">
                                            <div class="form-group mb-3">
                                                <input type="text" name="condemn_date" id="condemn_date" placeholder="Condemn Date" class="form-control form-cntrol-sm" readonly>
                                            </div>
                                        </div>

                                        <div class="row">
                                            <div class="form-group mb-3">
                                                <input type="text" name="condemn_quantity" id="condemn_quantity" placeholder="Condemn Quantity" class="form-control form-cntrol-sm" readonly>
                                            </div>
                                        </div>

                                        <div class="row">
                                            <div class="form-group mb-3">
                                                <input type="text" name="status" id="status" placeholder="Status" class="form-control form-cntrol-sm" readonly>
                                            </div>
                                        </div>
                                    </fieldset>
                                </div>
    ...
    <script src="confirmCondemn/loadPendingCondemnData.js"></script>
