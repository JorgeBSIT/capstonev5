<?php
    ...
    if(isset($_POST["query"])) {
        ...
        OR transferred_date LIKE '%".$search."%'
        OR p_in_charge LIKE '%".$search."%'
        OR transfer_confirmed_by LIKE '%".$search."%'
        ";
    } else {
        $query = "
        ...
        <table class="table table-striped table-hover table-bordered text-center">
            <thead class="table-dark">
                <tr>
                    ...
                    <th scope="col">Transfer Confirmed By</th>
                    <th scope="col"></th>
                </tr>
            </thead>';
            while($row = mysqli_fetch_array($result)) {
                ...
                $output .= '
                    <tr>
                        ...
                        <td class="transfer_confirmed_by">'.$row["transfer_confirmed_by"].'</td>
    ...
    echo "<script src='transferEquipment/select.js'></script>";
?>