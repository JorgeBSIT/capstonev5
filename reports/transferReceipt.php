    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-sm-10 d-flex justify-content-center">
                <h2 class="fs-5 text-center mt-3">TRANSFER RECEIPT</h2>
            </div>
        ...
        <div class="row">
            ...
            <div class="col-sm-10 d-flex justify-content-center">
                <h2 class="fs-5 text-center">PHYSICAL INVENTORY FOR PROPERTY, PLANT, AND EQUIPMENT TRANSFER RECEIPT</h2>
            </div>
                ...
                <?php
                    ...
                    if(mysqli_num_rows($result) > 0) {
                        while($row = $result->fetch_assoc()) {
                            $personInCharge = $row['p_in_charge'];
                        }
                    }
                ...
                <table class="table table-striped table-hover mt-4 text-center table-bordered border-dark">
                    <thead class="table-secondary border-dark">
                        <tr>
                            ...
                            <th scope="col">Previous Person in charge</th>
                            <th scope="col">Transferred Date</th>
                            <th scope="col">New Person in charge</th>
                        </tr>
                    </thead>
                    <tbody>
                        <?php
                            ...
                            if($result->num_rows > 0) {
                                while($row = $result->fetch_assoc()) {
                                    ...
                                    echo "<tr>";
                                        ...
                                        echo "<td>".$transferred_date[$index]."</td>";
                                        echo "<td>".$p_in_charge[$index]."</td>";
                                    echo "</tr>";
